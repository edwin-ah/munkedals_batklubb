<x-app-layout>
  <div class="container mx-auto mt-5">
    <h1 class="text-center text-2xl font-semibold text-main work-sans">Lägg till aktuell information</h1>
    <div class=" mt-10 pt-8 pb-10 bg-white rounded shadow-xl">
      <div class="p-10">
        <form action="{{ route('current-information.add') }}" method="POST">
          @csrf
          <div class="mb-4">
            <x-forms.text-input id="header" label="Ange Rubrik" :value="old('header')" />
          </div>
          <div class="mb-4">
            <label for="description" class="block text-gray-500 font-bold mb-2">Ange beskrivning</label>
            <textarea 
